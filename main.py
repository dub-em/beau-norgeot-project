import json, utilities, variables, time
...
def dictionary_scoring(dictionary_1, dictionary_2, nlp, model, tokenizer):
    ...
    print(f"Finished calculating Jaccard, BioBERT-Cosine, Ensemble, Recall, Precision, F1-Score scoring in {round((finish_1-start_1)/60, 2)} minute(s)")
...
if __name__ == "__main__":
    ...
    print(f"Finished the entire dictionary-to-dicitonary evaluation in {round((finish-start)/60, 2)} minute(s)")